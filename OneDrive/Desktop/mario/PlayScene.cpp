	...
	*/
	...
	void CPlayScene::Update(DWORD dt)
	{
		...
		static DWORD lastTimerUpdate = GetTickCount();
		if (GetTickCount() - lastTimerUpdate >= 1000 && timeLeft > 0)
		{
			timeLeft--;
			lastTimerUpdate = GetTickCount();
		}
	...
	void CPlayScene::Render()
	{
		...
		hud.Render(cx + 8, cy + 8, score, coins, timeLeft, life);
